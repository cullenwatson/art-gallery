...
After cloning the repo, navigate to the working directory in the command prompt to the folder where main.cpp is located. Once there, type g++ main.cpp to compile the program. Afterwards, to run type for Mac/Linux: ./{name of executable} {name of input file} or for Windows: {name of executable} {name of input file}
