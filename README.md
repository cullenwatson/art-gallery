...
Alternatively to the brute force is the most valuable first algorithm. This sorts the total list of paintings in descending order of value. It then repeatedly places onto the wall the next hihghest value painting that will fit. This process continues until there is no more room on the wall.
